...
import dask
# import glob
# WRF_FILE = glob.glob(r"*.nc")

# dsLocal = xr.open_dataset(r"wrfFrema\3km\FREMAA_2024060500Z.nc", 
#                       engine="netcdf4")

# ds = xr.open_mfdataset(r"wrfFrema\3km\*.nc",concat_dim=['lon', 'lat'],
                    # combine="nested", parallel=True ,engine="netcdf4")
ds = xr.open_mfdataset(r"testfrema\*.nc",combine="by_coords", 
